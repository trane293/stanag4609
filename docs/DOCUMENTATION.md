...
| Deploy PyAV, ONNX, Ultralytics, and Triton | Video decode plus local and remote inference choices | Examples exist; PyAV and a real ONNX session are dependency-gated, Ultralytics and Triton runtime jobs remain |
