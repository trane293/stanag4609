...
| Read, validate, write, and losslessly update ST 0601.19 | Complete active-item registry, strict/preserve decoders, canonical encoder, lossless updater, Report-on-Change state, source-bound complete ST 0806.4, ST 1002.3, ST 1010.3, ST 1206.1, ST 1601.2, and ST 1602.2 child profiles for Items 73/95/97/98/99/102, and [requirement trace](requirements/ST0601.19.md) | Every active item and active requirement identifier has structural or contextual evidence; the whole-standard claim remains conditional on producer facts and separately invoked profiles |
