...
| Read, validate, write, and losslessly update ST 0601.19 | Complete active-item registry, strict/preserve decoders, canonical encoder, lossless updater, Report-on-Change state, source-bound complete ST 0806.4, ST 1206.1, and ST 1601.2 child profiles for Items 73/95/98, and [requirement trace](requirements/ST0601.19.md) | Every active item and active requirement identifier has structural or contextual evidence; the whole-standard claim remains conditional on producer facts and the remaining separately invoked child standards |
