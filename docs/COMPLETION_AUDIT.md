...
| Read recorded and arbitrarily chunked live MPEG-2 TS | `TransportDemuxer`, incremental TS/PSI/PES/KLV parsers, complete bounded adaptation-field structure parsing, bounded RTP reorder/receiver path, UDP receivers, real-fixture tests, randomized chunk tests | Proven for implemented H.222.0/ST 1402 structures and ST 0804 multiplexed-TS RTP carriage |
