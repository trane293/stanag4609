...
| Write and modify STANAG 4609 transport | `TransportMuxer`, `LiveTransportTransformer`, typed adaptation-field encoders, CSV/KLV muxer, byte-preserving media tests, generated real-media acceptance | Proven for selected-program SPTS output and canonical adaptation-field construction; whole-MPTS rewriting remains outside this API |
