...
`video.h262.bit_rate` and `video.h262.vbv_buffer_size` reconstruct the complete
values split across the sequence header and sequence extension, convert their
